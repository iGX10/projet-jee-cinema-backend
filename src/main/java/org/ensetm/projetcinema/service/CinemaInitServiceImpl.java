package org.ensetm.projetcinema.service;

import org.ensetm.projetcinema.dao.*;
import org.ensetm.projetcinema.models.*;
...
public class CinemaInitServiceImpl implements ICinemaInitService {
    ...
    public void initCinemas() {
        villeRepository.findAll().forEach(ville -> {
            Stream.of("Megarama", "IMAX", "FOUMOUN", "CHAHRAZAD", "DAOULIZ").forEach(nameCinema -> {
    ...
    public void initFilms() {
        ...
        Stream.of("12 Hommes en colere", "Forrest Gump", "Green Book", "La Ligne Verte", "Le Parrain", "Le Seigneur des anneaux").forEach(titreFilm -> {
            ...
            film.setPhoto(titreFilm.replaceAll(" ", "_")+".jpg");
    ...
    public void initCategories() {
        Stream.of("Histoire", "Action", "Fiction", "Drama").forEach(categ -> {
